...
export default (props: IProps) => {
  ...
  React.useEffect(() => {
    ...
    if (blockNum > blockNumber) {
      props.history.push(`${process.env.PUBLIC_URL}/stats/miners/${blockNumber}`);
    }
    if (blockNum < 0) {
      props.history.push(`${process.env.PUBLIC_URL}/stats/miners/0`);
    }
    ...
    <>
      <BlockPagination
        ...
        onPrev={() => {
          ...
          props.history.push(`${process.env.PUBLIC_URL}/stats/miners/${newQuery}`);
        }}
        onNext={() => {
