...
function TxView(props: ITxViewProps) {
  ...
  return (
    <div>
      <Button
        onClick={() => {
          history.push(`${process.env.PUBLIC_URL}/tx/${tx.hash}/raw`);
        }}
        ...
        <TableBody>
            ...
            <TableCell>
              <Link
                component={({ className, children }: { children: any, className: string }) => (
                  <RouterLink className={className} to={`${process.env.PUBLIC_URL}/block/${tx.blockHash}`} >
                    {children}
                  </RouterLink>
                )}>
                {tx.blockHash}
          ...
          <TableRow>
            ...
            <TableCell>
              <Link
                component={({ className, children }: { children: any, className: string }) => (
                  <RouterLink className={className} to={`${process.env.PUBLIC_URL}/address/${tx.from}`} >
                    {children}
                  </RouterLink>
                )}>
                {tx.from}
          ...
          <TableRow>
            ...
            <TableCell>
              {tx.to !== null ?
                <Link
                  component={({ className, children }: { children: any, className: string }) => (
                    <RouterLink className={className} to={`${process.env.PUBLIC_URL}/address/${tx.to}`} >
                      {children}
                    </RouterLink>
                  )}>
                  {tx.to}
          ...
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell>
                <Link
                  component={({ className, children }: { children: any, className: string }) => (
                    <RouterLink className={className} to={`${process.env.PUBLIC_URL}/block/${receipt.blockHash}`} >
                      {children}
                    </RouterLink>
                  )}>
                  {receipt.blockHash}
            ...
            <TableRow>
              ...
              <TableCell>
                <Link
                  component={({ className, children }: { children: any, className: string }) => (
                    <RouterLink className={className} to={`${process.env.PUBLIC_URL}/address/${receipt.from}`} >
                      {children}
                    </RouterLink>
                  )}>
                  {receipt.from}
            ...
            <TableRow>
              ...
              <TableCell>
                <Link
                  component={({ className, children }: { children: any, className: string }) => (
                    <RouterLink className={className} to={`${process.env.PUBLIC_URL}/address/${receipt.to}`} >
                      {children}
                    </RouterLink>
                  )}>
                  {receipt.to}
            ...
            <TableRow>
              ...
              <TableCell>
                <Link
                  component={({ className, children }: { children: any, className: string }) => (
                    <RouterLink className={className} to={`${process.env.PUBLIC_URL}/address/${receipt.contractAddress}`} >
                      {children}
                    </RouterLink>
                  )}>
