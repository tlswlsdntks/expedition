...
function BlockView(props: any) {
  ...
  return (
    <div>
      <Button
        onClick={() => { history.push(`${process.env.PUBLIC_URL}/block/${block.hash}/raw`); }}
        ...
        <TableBody>
            ...
            <TableCell>
              <Link
                component={({ className, children }: { children: any, className: string }) => (
                  <RouterLink className={className} to={`${process.env.PUBLIC_URL}/block/${parentHash}`}>
                    {children}
                  </RouterLink>
                )}>
                {parentHash}
          ...
          <TableRow>
            ...
            <TableCell>
              <Link
                component={({ className, children }: { children: any, className: string }) => (
                  <RouterLink className={className} to={`${process.env.PUBLIC_URL}/address/${miner}`}>
                    {children}
                  </RouterLink>
                )}>
                {miner}
